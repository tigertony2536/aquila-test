...
const Icon = ({ height }: IconProps) => (
  <svg
    className="rotate-quater-animation"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="54.453128814697266 54.45212936401367 691.09375 691.095947265625"
    height={height}
  >
    <g clipPath="url(#__lottie_element_2)">
      <g
        transform="matrix(-0.004506909754127264,0.9999898672103882,-0.9999898672103882,-0.004506909754127264,400,400)"
        opacity={1}
        style={{
          display: 'block'
        }}
      >
        <path
          ...
          stroke="rgb(0,0,0)"
          strokeOpacity={1}
          strokeWidth={20.293038524697092}
